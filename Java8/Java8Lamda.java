public class Java8Lamda{
	public static void main(String[] args){
		...
		MathOperation<Integer> addInt=(a,b)->{return a+b;};
		MathOperation<Integer> subtractInt=(a,b)->{return a-b;};
	...
	private static interface NoArgLambda{
	...
	private static interface MathOperation<T>{
